...
<!-- option 1: CCT may (re)license under *any* FOSS license
how to apply: just keep the below paragraph and remove the paragraphs of option 2 and 3
--->
...
<!-- option 2: the project has a specific license it wants to keep forever
how to apply: state the applicable license(s) below using SPDX short identifiers and remove option 3 paragraph
...
<!-- option 3: the project has a specific (re)licensing policy
how to apply: assure there is a (re)licensing policy in place and link to it below, also remove option 2 paragraph above
--->
